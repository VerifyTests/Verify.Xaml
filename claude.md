...
- CI is GitHub Actions (`.github/workflows/build.yml`); on test failure it uploads any `*.received.*` files as artifacts — a hint when triaging CI-only XAML/PNG diffs.
